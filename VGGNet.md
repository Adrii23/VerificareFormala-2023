...
<p align="justify">Acest model e diferit de modelele performante anterioare in mai multe moduri. In primul rand, a folosit un mic camp receptiv de 3x3 cu o defazare de 1 pixel - pentru comparatie, AlexNet a folosit un camp receptiv de 11x11 cu o defazare de 4 pixeli. Filtrele de 3x3 se combina pentru a oferi functia unui camp receptiv mai mare.

<p align="justify">Avantajele utilizarii unor straturi mai mici in locul unui singur strat mare fac referire la faptul ca multe straturi active non-liniarea insotesc straturi de convolutie care imbunatatesc functiile de decizie si permit retelei sa converga mai repede.
...
<div align="center">
    <img height="92" width="726" src="https://github.com/mirceazco/VerificareFormala-2023/blob/main/LaTeX/procent.png">
</div>
